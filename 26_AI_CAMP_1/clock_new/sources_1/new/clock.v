...
module top_stopwatch (
    ...
    assign hour = lap_sw ? w_lap_hour : w_hour;
    assign min = lap_sw ? w_lap_min : w_min;
    assign sec = lap_sw ? w_lap_sec : w_sec;
    assign msec = lap_sw ? w_lap_msec : w_msec;


stopwatch_datapath #(.F_COUNT(F_COUNT)) 
...
module stopwatch_datapath #(
    ...
    parameter MSEC_WIDTH = 7, SEC_WIDTH = 6, MIN_WIDTH = 6, HOUR_WIDTH = 5, F_COUNT = 1_000_000)
...
time_counter #(
 ...
 tick_gen_100hz #(.F_COUNT(F_COUNT)
    )U_TICK_GEN_100HZ 
(
    .clk(clk),
    .reset(reset),
