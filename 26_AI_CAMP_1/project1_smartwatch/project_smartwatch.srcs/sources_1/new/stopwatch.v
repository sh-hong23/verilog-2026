...
module top_stopwatch (
    ...
    assign disp_hour = sw[2] ? w_lap_hour : w_hour;
    assign disp_min  = sw[2] ? w_lap_min : w_min;
    assign disp_sec  = sw[2] ? w_lap_sec : w_sec;
    assign disp_msec = sw[2] ? w_lap_msec : w_msec;
